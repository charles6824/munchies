...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="space-x-[2vw] uppercase mt-[1vw]">
        <button className=" border-[1px] border-white rounded-[2vw] bg-transparent text-white md:w-[12vw] px-2 py-[0.8vw]">
          VIEW VIDEO
        </button>
        <button className=" border-[1px] border-white rounded-[2vw] bg-transparent text-white md:w-[12vw] px-2 py-[0.8vw] uppercase">
          View Ticket
        </button>
      </div>
    </div>
