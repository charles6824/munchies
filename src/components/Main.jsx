...
const Main = () => {
	...
	const HandleQuestion = async(e) => {
		...
		if(!name || !mobile || !question){
			...
			try {
				axios.post('https://munchies-backend.onrender.com/api/messages', {name, mobile, question}, {
					headers: {
					...
					<div className="row">
						...
						<div className="col-md-4">
							<div className="">
								...
								<div className="card-body">
									<h3>Seasonal Soul Talks</h3>
									<br />
									<p className="pb-3 pt-1">Wed 4th Oct | Waterfall</p>
									<h3>From R250.00</h3>
								</div>
							</div>
						</div>
				...
				<div className="container py-4">
					<div className="row">
						<div className="col-md-6 rel" style={{position: 'relative'}}>
							...
							<IoLogoYoutube className="scale-[5] md:scale-[7] transition-all cursor-pointer text-red-500" style={{position: 'absolute', top: '50%', right: '50%', zIndex: '999'}} onClick={HandleLink} />
							<div className="bg-[#fff]" style={{position: 'absolute', top: '46%', right: '46%', zIndex: '99', background: '#fff', height: "46px", width: '50px'}}></div>
						</div>
						...
						<div className="col-md-5 mt-3 mt-md-0">
							...
							<p>
							The Munchies and Thoughts YouTube Channel Show Hosted by Chef Phathanani Mbatha is a cooking show that combines passionate cooking with meaningful conversations with influential individuals from various industries.
							</p>
							<p>
							The show aims to discuss societal challenges over tasteful munchies while also sharing educational thoughts. Through the show, they are granted an opportunity to share their wisdom and challenges with the world.
							</p>
				...
				<div className="container">
					<div className="row justify-content-center text-center">
						...
						<div className="col-md-5 relative text-left">
							...
							<p>
							Discover the remarkable narrative of our host, Phathanani Mbatha, in his compelling book, 'On My Own.' Born from humble beginnings in rural Kwazulu-Natal, Phathanani's story is a testament to the transformative power of passion and perseverance.
							</p>
							<p id="p">‘On My Own' serves as a source of inspiration for those aspiring to overcome obstacles and pursue their dreams.</p>
			...
			<section className="contact py-5" id="questions">
				<div className="container">
					...
					<div className="col-md-5">
							...
							<h5 className="cur-text1">Got burning questions or curious thoughts? We're all ears! </h5>
							<p>You can submit your munchies and thoughts Q & A questions here</p>
						</div>
						<div className="col-md-1"></div>
						<div className="col-md-6">
							{/* <h2>Ask Anything</h2> */}
							<p className="text1 text-secondary">
							No question is too big or too small. Whether it's about spirituality, relationships, or just life in general, we want to hear from you {" "}
							</p>
					...
					<div className="row justify-center">
						<div className="col-md-6 order-2 order-md-1">
							...
							<div className="md:w-[85%]">
								<p>
								Founded by Chef Phathanani Mbatha, driven by a vision to create positive change in the lives of young girls. Established in 2012 and registered with the Department of Social Development, the foundation has been actively operating ever since. <br />Our main goal is to create opportunities for underprivileged girls by offering necessities such as toiletries, school shoes, school bags, bedding, career guidance, and mentorship. <br />Join us on this transformative journey. Your support, whether big or small, makes a meaningful impact.
								</p>
								<p className="text">
								...
								<button
									className="rounded-[5vw] md:rounded-[1vw] bg-[#F6D95C] text-black font-poppins py-[2vw] md:py-[0.7vw] px-[1.7vw] uppercase form-control"
								>
									MAKE A DONATION
								</button>
								</div>
				...
				<div className="container md:text-center">
					...
					<div className="row justify-center py-3 text-[#4378f5]">
						<div className=" col-12 col-md-3 my-2">
							...
							<h4>Email</h4>
							<p className="md:pt-4 whitespace-wrap"><Link to="mailto:hello@munchiesandthoughts.co.za">live@munchiesandthoughts.co.za</Link></p>
						</div>
